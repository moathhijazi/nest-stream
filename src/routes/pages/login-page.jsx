  ...
  return (
    <div className="w-full h-screen flex flex-col space-y-10 justify-center items-center">
      <h2 className="font-bold sm:text-md md:text-lg lg:text-2xl">
        ...
        Please login to start watching!
      </h2>
      <div className="p-4 bg-[#39393e] rounded-sm sm:w-[50%] md:w-[45%] lg:w-[30%] shadow-md ">
        <p className="text-center text-sm">Continue login with</p>
        ...
        <div className="w-full border-t-[.4px] border-t-[#dfdfe3] p-2 mt-6 flex justify-center">
            <span className="text-xs bg-[#39393e] p-2 -mt-6">Or Continue with</span>
        </div>
        <div className="w-full flex flex-col">
            <div className="my-1">
                <Input type="text" placeholder="Username : john_doe ..."  onChange={e => setUsername(e.target.value)} />
            </div>
            <div className="my-1">
                <Input type="password" placeholder="Password : ****** ..." onChange={e => setPassword(e.target.value)}  />
            </div>
            <Button variant="nest" size="lg" className="w-[120px] mt-4" disabled={loading || !username || !password} onClick={() => handleSubmit()}>
                <span>Login</span>
            </Button>
        </div>
      </div>
      <p className="sm:w-[50%] md:w-[45%] lg:w-[30%]"><a href="/signup" className="text-[#f1455f] hover:underline cursor-pointer">Click here</a> if you do not have an account</p>
    </div>
  );
}
